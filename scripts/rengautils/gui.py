...
class RengaGui(Tkinter.Tk):
    ...
    def ask_for_comment(self):
        ...
        self.entry = ttk.Entry(self.mainframe, font=self.font, textvariable=self.cmt)
    ...
    def alert(self, msg):
        ttk.Label(self.mainframe, font=self.font, text=msg).grid(column=1, row=0, sticky="W")
    ...
    def issue_report(self):
        ...
        ttk.Label(self.mainframe, font=self.font, text=info).grid(column=0, row=0, sticky="W")
        self.cmt = Tkinter.Text(self.mainframe, font=self.font, width=60, height=10)
